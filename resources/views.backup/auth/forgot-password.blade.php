...
<head>
    ...
    <title>Mot de passe oublié - Mbacol Communication</title>
            ...
            <div class="mb-6 text-center">
                <nav class="flex justify-center" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-2 text-sm">
                        ...
                        <li>
                            <a href="{{ route('login') }}" class="text-gray-500 hover:text-primary-600">Connexion</a>
                        </li>
                        <li>
                            <span class="text-gray-400">/</span>
                        </li>
                        <li class="text-primary-600 font-semibold">Mot de passe oublié</li>
                    </ol>
                </nav>
            </div>
                    ...
                    <div class="hidden lg:flex items-center justify-center bg-gradient-to-br from-primary-600 via-primary-700 to-secondary-600 p-12 relative overflow-hidden">
                        ...
                        <div class="text-center relative z-10">
                            ...
                            <p class="text-white/90 text-lg mb-8 max-w-md mx-auto">
                                Nous allons vous aider à récupérer l'accès à votre compte en quelques minutes
                            </p>
