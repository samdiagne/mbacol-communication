<div>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        @if($cartItems->count() > 0)
            ...
            <div class="mt-2 scroll-reveal">
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-6 lg:p-8 shadow-lg">
                    <div class="flex flex-col lg:flex-row items-start lg:items-center gap-6">
                        <!-- Icône -->
                        <div class="flex-shrink-0">
                            <div class="w-16 h-16 lg:w-20 lg:h-20 bg-white rounded-2xl flex items-center justify-center shadow-md">
                                <svg class="w-10 h-10 lg:w-12 lg:h-12 text-green-500" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Contenu -->
                        <div class="flex-1">
                            <h3 class="text-xl lg:text-2xl font-bold text-gray-900 mb-2 flex items-center gap-2">
                                💬 Vous préférez WhatsApp ?
                            </h3>
                            <p class="text-gray-700 mb-4">
                                Commandez directement via WhatsApp ! Nous confirmerons la disponibilité, 
                                le prix et organiserons la livraison avec vous.
                            </p>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
                                <div class="flex items-center gap-2 text-sm text-green-800">
                                    ...
                                    <span class="font-medium">Pas de compte requis</span>
                                </div>
                                <div class="flex items-center gap-2 text-sm text-green-800">
                                    <svg class="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                ...
                                <div class="flex items-center gap-2 text-sm text-green-800">
                                    ...
                                    <span class="font-medium">Réponse immédiate</span>
                                </div>
                            </div>
                            ...
                            <a href="https://wa.me/221784465192?text={{ urlencode($cartMessage) }}" 
                               ...
                               class="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-8 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 group">
                                ...
                                <span class="bg-white/20 text-xs font-semibold px-2 py-1 rounded-full">
