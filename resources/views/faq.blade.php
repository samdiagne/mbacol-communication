...
@section('content')
<div class="bg-gradient-to-br from-gray-50 to-primary-50/20 py-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                ...
                <a href="{{ route('contact') }}" class="text-primary-600 hover:text-primary-700 font-semibold underline">contactez-nous</a>.
            </p>
        </div>
        ...
        <div class="mb-8">
            ...
            <div class="space-y-3" x-data="{ openIndex: null }">
                ...
                @endphp
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-200 overflow-hidden border border-gray-100">
                    <button @click="openIndex === '{{ $globalIndex }}' ? openIndex = null : openIndex = '{{ $globalIndex }}'"
                        ...
                        <span class="font-semibold text-gray-900 pr-4 flex-1">
                            {{ $faq['question'] }}
                        </span>
