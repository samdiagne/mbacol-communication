...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
        ...
        <div class="scroll-reveal-right">
            ...
            <!-- Partager -->
            <div class="border-t border-gray-200 pt-6 mb-6" x-data="{ copied: false }">
                <p class="text-sm font-semibold text-gray-700 mb-3">Partager ce produit</p>
                <div class="flex items-center gap-3">
                    <!-- WhatsApp -->
                    <a href="https://wa.me/?text={{ urlencode($product->name . ' - ' . $product->formatted_price . ' | ' . route('product.show', $product)) }}"
                       target="_blank" rel="noopener noreferrer"
                       class="flex items-center justify-center w-10 h-10 rounded-full bg-green-500 hover:bg-green-600 text-white transition">
                    ...
                    <!-- Facebook -->
                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('product.show', $product)) }}"
                       target="_blank" rel="noopener noreferrer"
                       class="flex items-center justify-center w-10 h-10 rounded-full bg-blue-600 hover:bg-blue-700 text-white transition">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </a>
                    <!-- Copier le lien -->
                    <button @click="navigator.clipboard.writeText('{{ route('product.show', $product) }}'); copied = true; setTimeout(() => copied = false, 2000)"
                    ...
                    <span x-show="copied" x-cloak x-transition class="text-sm text-green-600 font-medium">Lien copié !</span>
                </div>
            </div>
